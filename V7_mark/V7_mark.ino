...
//compteurs timer
volatile int compteurUS_T5;
volatile int compteurIR_T5;
volatile int compteurKnob_T5;
volatile int compteurBumper;
  ...
  while (1) {
    switch (etat) {
      ...
      case MARCHE: {
          ...
          //capteurs ultrason
          if (USDistFront < 15 || USDistRight < 15 || USDistLeft < 15) {
            etat = AU;
            codeAU = DISTANCE;
          }
          ...
          // test gyroscope
//          float vitesseRotation = gyro.readFloatGyroZ();
